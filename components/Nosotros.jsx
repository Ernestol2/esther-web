...
export default function Nosotros() {
  return (
    <section className="nosotros-container" id="nosotros">
        ...
        <p>Hoy en día ofrecemos servicios que van desde tortas de cumpleaños, matrimonios, 15 años, baby showers, géneros reveal, corporativos, desayunos sorpresas, catering y mesas de dulces para todo tipo de estos eventos, siempre innovando y buscando plasmar un hermoso recuerdo partiendo de la idea inicial de nuestros clientes.</p>
    </section>
  )
}
